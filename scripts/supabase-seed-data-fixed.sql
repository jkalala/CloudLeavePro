-- CloudLeave Supabase Seed Data (Fixed Version)
-- Run this AFTER creating the auth users and getting their UUIDs

-- STEP 1: First create these users in Supabase Auth Dashboard:
-- employee@adpa.com (password: password123)
-- supervisor@adpa.com (password: password123)  
-- hr@adpa.com (password: password123)
-- director@adpa.com (password: password123)

-- STEP 2: Get the UUIDs from Auth > Users and replace the UUIDs below
-- STEP 3: Run this script

-- Insert demo user profiles (REPLACE THESE UUIDs WITH ACTUAL ONES FROM AUTH)
