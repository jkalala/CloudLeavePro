-- CloudLeave Supabase Database Schema (Clean Version)
...
-- Users policies - Allow users to read their own data and insert during signup
...
-- Business configs and leave types are readable by all authenticated users
